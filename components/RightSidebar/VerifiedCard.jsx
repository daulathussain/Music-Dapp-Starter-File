    ...
    <>
      ...
      <div>
        <div className="block md:!hidden">
          <div className="c-PJLV c-PJLV-ihHUeqO-css md:[&_svg]:hover:rounded-full md:[&_svg]:hover:shadow-secondary">
            <svg
              width={16}
              height={17}
              viewBox="0 0 16 17"
        ...
        <div className="!hidden md:!block">
          <div
            className="c-PJLV c-PJLV-ihHUeqO-css cursor-default hover:cursor-default md:[&_svg]:hover:rounded-full md:[&_svg]:hover:shadow-secondary"
            data-state="closed"
          >
            <svg
              width={16}
